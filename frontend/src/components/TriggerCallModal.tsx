    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        <div className="px-6 py-5 bg-surface border-b border-border flex items-center justify-between">
          <h2 className="text-[16px] font-bold text-textPrimary flex items-center gap-2">
            <PhoneCall className="w-4 h-4 text-primary" />
            Trigger Call
          </h2>
          <button onClick={onClose} className="p-1 rounded-md text-textMuted hover:bg-white border border-transparent hover:border-border transition-all">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6">
            ...
            <div className="flex flex-col gap-4 animate-in fade-in">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className={`w-full border rounded-[8px] pl-3 pr-3 py-2 text-[14px] bg-white outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all ${phoneError ? 'border-error' : 'border-border'}`}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input 
                  ...
                  className="w-full border border-border rounded-[8px] px-3 py-2 text-[14px] bg-white outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
          ...
          {step === 2 && (
            <div className="flex flex-col items-center justify-center py-8 gap-4 animate-in fade-in zoom-in-95">
              ...
              <p className="text-textPrimary font-medium text-[15px]">Fetching availability & placing call...</p>
          ...
          {step === 3 && (
            <div className="flex flex-col items-center justify-center py-6 gap-3 animate-in fade-in zoom-in-95">
              <div className="w-14 h-14 bg-green-100 rounded-full flex items-center justify-center text-success mb-2">
                <CheckCircle2 className="w-8 h-8" />
              </div>
              <p className="text-textPrimary font-bold text-[18px]">Call triggered successfully!</p>
              <div className="bg-surface border border-border rounded-[8px] px-4 py-3 w-full text-center">
          ...
          {step === 4 && (
            <div className="flex flex-col items-center justify-center py-6 gap-3 animate-in fade-in zoom-in-95">
              <div className="w-14 h-14 bg-red-100 rounded-full flex items-center justify-center text-error mb-2">
                <X className="w-8 h-8" />
              </div>
              <p className="text-textPrimary font-bold text-[18px]">Call Failed</p>
